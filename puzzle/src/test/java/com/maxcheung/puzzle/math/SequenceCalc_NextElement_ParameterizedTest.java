...
public class SequenceCalc_NextElement_ParameterizedTest {
	 ...
	 */
	public SequenceCalc_NextElement_ParameterizedTest(int nthPosition, int precedingElementsC, String nthElementValue,
			String expected) {
