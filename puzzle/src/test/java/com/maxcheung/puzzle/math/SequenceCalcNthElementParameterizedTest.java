...
public class SequenceCalcNthElementParameterizedTest {
    ...
    public SequenceCalcNthElementParameterizedTest(int totalElementsN, int precedingElementsC, String expected) {
